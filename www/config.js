...
async function Config() {
  ...
  const language =
    preferencesStore.get('language') || navigator.language || DEFAULT_LANGUAGE;
  ...
  document
    .getElementById('body')
    .setAttribute('transition-animations-disabled', !transitionAnimations);
  ...
  console.log(`[${new Date().toLocaleString()}][Config] Language: ${language}`);
