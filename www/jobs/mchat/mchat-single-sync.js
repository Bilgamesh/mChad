...
import { MchatEmoticonsService } from '../../services/mchat/mchat-emoticons.js';
import { MchatOnlineUsersService } from '../../services/mchat/mchat-online-users.js';
import { MchatChatService } from '../../services/mchat/mchat-posts.js';
import { MchatUserService } from '../../services/mchat/mchat-user.js';
...
function MchatSingleSynchronizer({
  ...
  function extractLikeMessage(messages) {
    if (messages.length && messages[0].likeMessage) {
      const likeMessage = documentUtil.unicodeToString(messages[0].likeMessage);
...
export { MchatSingleSynchronizer };
