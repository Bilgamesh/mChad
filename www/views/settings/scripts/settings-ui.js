...
function SettingsUi({ el, config, selectedLanguage }) {
  ...
  function registerHaptics() {
    ...
    document
      .getElementById('local-notifications-toggle')
      .addEventListener('click', hapticsUtil.tapDefault);
    document
      .getElementById('haptic-feedback-toggle')
      .addEventListener('click', hapticsUtil.tapDefault);
    document
      .getElementById('autorotate-toggle')
      .addEventListener('click', hapticsUtil.tapDefault);
    document
      .getElementById('transition-animations-toggle')
      .addEventListener('click', hapticsUtil.tapDefault);
    document
    ...
    document
      .getElementById('language-menu')
      .addEventListener('change', hapticsUtil.tapDefault);

    for (const color of document.getElementById('colors').children) {
  ...
  function addLanguageMenuChangeListener(listen) {
    document.getElementById('language-menu').addEventListener('change', listen);
  }
