(function () {
  function MchatLoginService({ baseUrl, urlUtil, fetchTool, documentUtil }) {
    ...
    async function loginWithCredentials(username, password) {
      ...
      otpData = {
        ...
        sid: documentUtil.findInputData(doc, 'sid', 'value'),
        submit: documentUtil.findInputData(doc, '#auth_otp > #submit_auth', 'action'),
  ...
  window.modules.MchatLoginService = MchatLoginService;
})();
